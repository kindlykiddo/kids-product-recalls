...
The dataset is also published on [Hugging Face](https://huggingface.co/datasets/kindlykiddo/kids-product-recalls) and [Kaggle](https://www.kaggle.com/datasets/kindlykiddo/kids-product-recalls). The weekly GitHub workflow synchronizes both distribution platforms from the canonical live exports.
